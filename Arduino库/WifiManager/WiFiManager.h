...
const char HTTP_PORTAL_OPTIONS[] PROGMEM  = "<form action=\"/wifi\" method=\"get\"><button>配置WiFi</button></form><br/><form action=\"/0wifi\" method=\"get\"><button>直接填写WIFI信息</button></form><br/><form action=\"/i\" method=\"get\"><button>关于</button></form><br/><form action=\"/r\" method=\"post\"><button>重置</button></form>";
...
const char HTTP_SAVED[] PROGMEM           = "<div>信息已经保存<br />正在让易晓同学连接到网络<br />如果失败了再试一下呗！</div>";
